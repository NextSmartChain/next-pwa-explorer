                ...
                <div class="col margin-bottom-menu">
                    <f-card>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fSelfStaked' in dTotals">{{ dTotals.fSelfStaked }} NEXT <span v-if="cSelfStaked">({{ cSelfStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalDelegated' in dTotals">{{ dTotals.fTotalDelegated }} NEXT <span v-if="cDelegated">({{ cDelegated }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalStaked' in dTotals">{{ dTotals.fTotalStaked }} NEXT <span v-if="cStaked">({{ cStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="cDailyRewards">{{ formatNumberByLocale(numToFixed(cDailyRewards, 0)) }} NEXT</div>
                            </div>
                        </div>
                ...
                <div class="col">
                    <f-card>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'epochFee' in cEpoch">{{  WEIToFTM(cEpoch.epochFee) }} NEXT</div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="dTotalSupply">{{ formatNumberByLocale(numToFixed(dTotalSupply, 0)) }} NEXT</div>
                            </div>
                        </div>
                    </f-card>
                </div>
