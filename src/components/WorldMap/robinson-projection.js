...
export function projectR(latitude, longitude, mapWidth, heightFactor, mapOffsetX, mapOffsetY) {
...
export function projectAbsoluteR(latitude, longitude, mapWidth, heightFactor, mapOffsetX, mapOffsetY) {
    if (typeof heightFactor === 'undefined') { heightFactor = 1; }

    var relative = projectR(latitude, longitude, mapWidth, heightFactor, mapOffsetX, mapOffsetY);
